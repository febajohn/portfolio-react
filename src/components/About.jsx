...
import febaimg from '../assets/febaimg.png'
  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="max-w-max mx-auto relative">
            <img src={febaimg} alt="" className="w-64 sm:w-80 rounded-3xl max-w-none"/>
        ...
        <div className="flex-1">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                ...
                ">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">HTML, CSS, JavaScript, React Js and PHP</p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">Master of Computer Applications [MCA]</p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
